...
@Name("DragonTravel - Take home")
@Description({"Takes the player to their home set by the plugin"})
@Syntaxes({"take %player% to[ their] dragon home"})
@Examples({""})
public class EffHomeTravel extends Effect {
   ...
   public String toString(@Nullable Event e, boolean debug) {
      return "take %player% to[ their] dragon home";
   }
   ...
   protected void execute(Event e) {
      ...
      try {
         DragonManager.getDragonManager().getTravelEngine().toHome(p, true);
