...
public class EffWings extends Effect {
   ...
   public boolean init(Expression[] exprs, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
      ...
      this.offY = exprs[5];
      this.offZ = exprs[6];
      this.inputParticleString2 = exprs[7];
      this.inputParticleData2 = exprs[8];
      this.speed2 = exprs[9];
      this.offX2 = exprs[10];
      this.offY2 = exprs[11];
      this.offZ2 = exprs[12];
      this.inputParticleString3 = exprs[13];
      this.inputParticleData3 = exprs[14];
      this.speed3 = exprs[15];
      this.offX3 = exprs[16];
      this.offY3 = exprs[17];
      this.offZ3 = exprs[18];
      this.entLoc = exprs[19];
      this.idName = exprs[20];
      this.singlePlayer = exprs[21];
      this.player = exprs[22];
      this.rainbMode = exprs[23];
      this.inputFlapSpeed = exprs[24];
      this.inputFlapRange = exprs[25];
      this.angle = exprs[26];
      this.height = exprs[27];
      this.space = exprs[28];
      this.range = exprs[29];
      this.ticks = exprs[30];
      this.seconds = exprs[31];
      return true;
   }
