...
public class EffWings extends Effect {
   ...
   protected void execute(@Nullable Event e) {
      ...
      int offsetX2T = SkriptHandler.inputInt(0, e, this.offX2T);
      int offsetY2T = SkriptHandler.inputInt(0, e, this.offY2T);
      int offsetZ2T = SkriptHandler.inputInt(0, e, this.offZ2T);
      ...
      int offsetX3T = SkriptHandler.inputInt(0, e, this.offX3T);
      int offsetY3T = SkriptHandler.inputInt(0, e, this.offY3T);
      int offsetZ3T = SkriptHandler.inputInt(0, e, this.offZ3T);
      ...
      if (finalStyle > 1) {
         if (finalStyle != 2) {
            ...
            finalHeight = (float)((double)finalHeight - 0.4D);
         }
      } else {
