...
public class EffColorImage extends Effect {
   ...
   public boolean init(Expression[] exprs, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
      ...
      skDragonCore.warn("        draw image file " + this.fileName.toString() + ", center " + this.entLoc.simplify() + ", id " + this.idName.toString() + (this.player != null ? ", clientside " + this.player : "") + (this.rotation != null ? ", rotation " + this.rotation : "") + (this.planeString != null ? ", plane " + this.planeString.toString().replaceAll("\"", "") : "") + ", auto face false" + ", xy pixel step " + this.pixelX.toString() + ", " + this.pixelY.toString() + (this.scale != null ? ", scale 1 / " + this.scale : "") + ", visible range " + this.range.toString() + (this.xRot != null ? ", xyz rotation " + this.xRot + ", " + this.yRot.toString() + ", " + this.zRot.toString() : "") + (this.displaceX != null ? ", xyz displacement " + this.displaceX + ", " + this.displaceY.toString() + ", " + this.displaceZ.toString() : "") + (this.seconds != null ? ", pulse rate " + this.seconds + " ticks" : ""));
