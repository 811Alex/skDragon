...
@Description({"Gets the displayname of a dragontravel station"})
@Syntaxes({"displayname of station named %string%"})
@Examples({"set {_name} to displayname of station named \"test\""})
public class ExprStationDisplayName extends SimpleExpression {
